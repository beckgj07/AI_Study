...
│  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐     │
│  │  教材上传    │───▶│   题库管理   │───▶│   闯关选择   │     │
│  │  /upload     │    │/question-bank│    │ /challenge   │     │
│  └──────────────┘    └──────────────┘    └──────────────┘     │
│         │                   │                   │              │
│         ▼                   ▼                   ▼              │
│  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐     │
...
| 功能模块 | 集成点 | 说明 |
|---------|--------|------|
| **闯关选择** | 题目来源 | 闯关时可选"教材题库"作为题目来源 |
| **答题测验** | 题目数据 | 从题库按科目/年级/难度随机抽取 |
| **错题本** | 题目关联 | 错题标记后自动关联到对应教材章节 |
| **AI讲解** | 题目详情 | 讲解时显示题目来源（教材/手动） |
| **学习报告** | 统计分析 | 按教材/题型/难度分析学习情况 |
...
4. **闯关页**：新增题目来源选择，支持按教材抽取
5. **答题页**：显示题目来源，点击可查看教材信息
6. **错题页**：支持按教材筛选
7. **报告页**：新增教材掌握度统计
8. **响应式**：移动端筛选器折叠为下拉菜单
